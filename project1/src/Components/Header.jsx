...
const Header = () => {
  return (
    <div className='dark:bg-gray-900 text-white flex justify-between items-center px-12 h-20'>
        ...
        <ul className='flex'>
            ...
            <div className='flex mx-4'>
                <span className='text-2xl mt-1'><IoHelp/></span>
                <Link to='/help'>
                    <li className='ml-4 text-2xl'>Help</li>
                </Link>
            </div>
            <div className='flex mx-4'>
                <span className='text-2xl mt-1'><GoSignIn/></span>
                <Link to='/signin'>
                    <li className='ml-4 text-2xl'>Sign-in</li>
                </Link>
            </div>
            <div className='flex mx-4'>
                <span className='text-2xl mt-1'><AiOutlineShoppingCart/></span>
                <Link to='/cart'>
